                ...
                <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div className="space-y-1">
                            ...
                            <input
                                ...
                                minLength={3}
                                maxLength={20}
                                className={`w-full border px-3 py-2 rounded-lg mt-1 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors ${isDark ? 'bg-gray-600 border-gray-600 text-gray-100 placeholder-gray-400' : 'bg-[#f0e6d0] border-[#e8dfc8] text-[#3d2f1f]'}`}
                    ...
                    <div className="mt-8 flex gap-3">
                        <button
                            ...
                            className={`cursor-pointer px-6 py-2.5 rounded-lg font-medium transition-all duration-200 text-white ${isSubmitting
