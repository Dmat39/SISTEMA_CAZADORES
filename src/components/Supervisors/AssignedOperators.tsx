    ...
    return (
        <Dialog open={isOpen} onClose={onClose} className="relative z-50">
            ...
            <div className="fixed inset-0 flex items-center justify-center p-4">
                <Dialog.Panel className="bg-[#fdfbf5] dark:bg-[#111827] border border-[#e8dfc8] dark:border-white/10 rounded-xl shadow-xl max-w-6xl w-full p-6">
                    <div className="mb-2 flex items-center">
                        <Dialog.Title className="text-lg font-bold text-[#3d2f1f] dark:text-white">
                            Personal asignado a:{' '}
                            <span className="text-[#a89878] dark:text-gray-400 ml-2 font-normal">{incidenceName}</span>
                        </Dialog.Title>
                        <button
                            type="button"
                            onClick={onClose}
                            className="ms-auto text-[#a89878] hover:bg-[#f0e6d0] dark:hover:bg-white/10 hover:text-[#3d2f1f] dark:hover:text-white rounded-lg w-8 h-8 inline-flex justify-center items-center transition-colors"
                        >
                    ...
                    <hr className="border-[#e8dfc8] dark:border-white/10 mb-4" />
