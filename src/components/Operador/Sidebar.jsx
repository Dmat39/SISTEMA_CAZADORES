    ...
    >
      <div className="h-full px-3 py-4 pb-4 overflow-y-auto bg-white">
        <ul className="space-y-3 font-medium">
          ...
          <li>
            <button type="button" onClick={() => handleNavigation("/dashboard/operador/incidencia")} className="cursor-pointer flex items-center p-2 text-gray-900 rounded-md dark:text-white hover:bg-[#32A3B5] group transition-all ease-in-out duration-300 w-full">
