    ...
    >
      <div className="h-full px-3 py-4 pb-4 overflow-y-auto bg-white dark:bg-gray-800 transition-colors duration-200">
        <ul className="space-y-3 font-medium">
          <li>
            <NavLink to="/dashboard/admin" end className="flex items-center p-2 text-gray-900 dark:text-white rounded-md hover:bg-[#32A3B5] dark:hover:bg-orange-600 group transition-all ease-in-out duration-300">
          ...
          <li>
            <NavLink to="/dashboard/admin/incidencia" end className="flex items-center p-2 text-gray-900 dark:text-white rounded-md hover:bg-[#32A3B5] dark:hover:bg-orange-600 group transition-all ease-in-out duration-300">
