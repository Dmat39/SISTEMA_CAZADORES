    ...
    <>
      ...
      >
        ...
        <nav className="shrink-0 overflow-y-auto overflow-x-hidden px-2 py-4 space-y-1">
          {!isCollapsed && (
            <p className="px-3 mb-2 text-[10px] font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-widest">
              Navegación
            </p>
          )}
          {items.map((item) => (
              ...
              className={({ isActive }) =>
                [
                  ...
                  isActive
                    ...
                    : 'text-gray-600 dark:text-gray-400 hover:bg-orange-50 dark:hover:bg-white/8 hover:text-orange-600 dark:hover:text-white',
                ].join(' ')
              }
            >
        ...
        {/* ── Footer ──────────────────────────────────────────── */}
        <div className="shrink-0 px-3 pb-4 border-t border-gray-200 dark:border-white/10 pt-3">
          {!isCollapsed && (
            <>
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-medium text-gray-500 dark:text-gray-400">Sistema en línea</span>
                </div>
                <span className="text-[10px] font-semibold text-gray-500 dark:text-gray-500">v1.0</span>
              </div>
          ...
          <button
            ...
            className="hidden sm:flex w-full items-center justify-center gap-2 px-3 py-2 rounded-xl text-xs font-semibold text-gray-500 dark:text-gray-400 hover:bg-orange-50 dark:hover:bg-white/8 hover:text-orange-600 dark:hover:text-white transition-all"
          >
            {isCollapsed
