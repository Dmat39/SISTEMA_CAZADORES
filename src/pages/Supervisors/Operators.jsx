            ...
            <div className="bg-white rounded-xl shadow-md p-3 sm:p-6 flex-1 flex flex-col">
                <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between mb-4 sm:mb-6">
                    <div className="block mb-4 lg:mb-0">
                        <h2 className="text-xl sm:text-2xl font-bold">Mantenimiento de Operadores</h2>
                        <p className="text-sm sm:text-base text-gray-600">Gestiona y organiza todos los operadores</p>
                    </div>
                        ...
                        <div className="w-full sm:flex-1 sm:min-w-[200px] lg:max-w-[300px]">
                            <div className='relative w-full'>
                                ...
                                <input
                                    ...
                                    className="w-full h-10 pl-4 pr-3 text-sm bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all"
                                />
                            </div>
                        </div>
