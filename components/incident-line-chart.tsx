    ...
    <div className="bg-white p-6 rounded-lg shadow-lg border">
      <div className="mb-4">
        <div className="flex items-center space-x-2 mb-2">
          ...
          <h3 className="text-lg font-semibold text-gray-900">Tendencia de Incidencias</h3>
        </div>
          ...
          <div className="flex space-x-1">
            {["24H", "7D", "30D"].map((period) => (
              <button
                ...
                className={`text-xs px-3 py-1 rounded ${selectedPeriod === period
        ...
        <div className="flex space-x-6 mt-4">
          <div>
            <div className="text-2xl font-bold text-teal-600">{pico}</div>
            <div className="text-xs text-gray-500">Pico</div>
          </div>
          <div>
            <div className="text-2xl font-bold text-teal-600">{promedio}</div>
